...
function calcStrength() {
  ...
  if (hasUpper && hasLower && (hasNum || hasSym) && passwordLength >= 8) {
    console.log("calcStrength  green function");
    setIndicator("#0f0");
  } else if (
    (hasLower || hasUpper) &&
    (hasNum || hasSym) &&
    ...
    console.log("calcStrength yellow function");
    setIndicator("#ff0");
  } else {
    console.log("calcStrength red function");
    setIndicator("#f00");
  }
...
function setIndicator(color) {
  console.log(`set indicator function ${color}`);
